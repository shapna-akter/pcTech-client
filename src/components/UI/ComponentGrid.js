...
const ComponentGrid = ({ pcData }) => {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center gap-4 my-8 mx-4 lg:mx-0">
      {pcData.map((product, i) => (
        ...
        >
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <Link className="w-full mt-2" href={"/build-pc"}>
              <Button
                onClick={() => dispatch(addToBuild(product))}
                type="primary w-full mb-0 mt-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 shadow-md shadow-orange-300"
              >
                Build
              </Button>
            </Link>
